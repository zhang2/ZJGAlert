...
@implementation DLEdgeInsetsButton
...
- (void)setEdgeInsetsStyle:(DLButtonEdgeInsetsStyle)edgeInsetsStyle {
    ...
    switch (edgeInsetsStyle) {
        case DLButtonEdgeInsetsStyleImageRight:
        {
            space = space * 0.5;
        ...
        case DLButtonEdgeInsetsStyleImageLeft:
        {
            space = space * 0.5;
            ...
            break;
        case DLButtonEdgeInsetsStyleImageBottom:
        {
            ...
            break;
        case DLButtonEdgeInsetsStyleImageTop:
        {
            CGFloat imageHeight = CGRectGetHeight(self.imageView.frame);
            CGFloat labelHeight = CGRectGetHeight(self.titleLabel.frame);
            CGFloat buttonHeight = CGRectGetHeight(self.frame);
